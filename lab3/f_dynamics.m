...
aIk = RBIk'*(fBtildek-bak-vak)-[0;0;P.constants.g];
omegaBk = omegaBtildek-bgk-vgk;
S = 1/(cos(ek(1)))*[cos(ek(1))*cos(ek(2)) 0 cos(ek(1))*sin(ek(2));
                    sin(ek(1))*sin(ek(2)) cos(ek(1)) -1*cos(ek(2))*sin(ek(1));
                    -1*sin(ek(2)) 0 cos(ek(2))];
eDotk = S*omegaBk;

rIkp1 = rIk+delt*vIk+0.5*aIk*delt^2;
vIkp1 = vIk+delt*aIk;
ekp1 = ek+delt*eDotk;
