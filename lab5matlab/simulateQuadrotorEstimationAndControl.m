...
%           Ms.rcArray = [Ms.rcArray, statek.rI+statek.RBI'*P.sensorParams.rocB];
          % Estimated position/attitude
          Ms.RCIArray = [Ms.RCIArray, P.sensorParams.RCB*E.statek.RBI];
          Ms.rcArray = [Ms.rcArray, E.statek.rI+E.statek.RBI'*P.sensorParams.rocB];
      end
